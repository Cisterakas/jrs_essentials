          ...
          <div class="div-4">
            ...
            <div class="column-2">
              <div class="div-10">
                ...
                <div class="div-12">
                    <router-link to="/toPay" type="button" class="div-13">To Pay</router-link>
                   
                <router-link to="/toShip" type="button" class="div-14">To Ship</router-link>
                <router-link to="/toReceive" type="button" class="div-13">To Receive</router-link>
                <router-link to="/toRate" type="button" class="div-13">To Rate</router-link>

                  
                </div>
                <div class="div-17">No orders yet</div>
              </div>
            </div>
          </div>
        </div>
