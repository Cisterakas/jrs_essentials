          ...
          <div class="div-18">
            <div class="div-19">
              ...
              <div class="div-23">
                <img
                  loading="lazy"
                  src="https://cdn.builder.io/api/v1/image/assets/TEMP/7134b6a6-d5af-4b29-b9d8-64f0a159f6ba?apiKey=3f6a7ddee9ae46558dc54af7e96aa0c9&"
                  class="img-8"
                />
                <div class="div-24">
                  <img
                    loading="lazy"
                    src="https://cdn.builder.io/api/v1/image/assets/TEMP/acfae3c5-94da-4664-ac42-227ca269f0c1?apiKey=3f6a7ddee9ae46558dc54af7e96aa0c9&"
                    class="img-9"
                  />
                  <div class="div-25">admin</div>
                </div>
              </div>
            </div>
            <div class="div-26">
              ...
              <div class="div-79">
                <div class="div-80">
                  ...
                  <div class="div-82">
                    ...
                    <div class="div-84">This week</div>
                    <div class="div-85">This month</div>
                    <div class="div-86">This year</div>
                  </div>
                </div>
                <div class="div-87">
                  <div class="div-88">
                    <img
                      ...
                      class="img-17"
                    />
                    <div class="div-89">Bleachpeel Soap</div>
                  </div>
                  <div class="div-90">
                    <div class="div-91">67</div>
                    <div class="div-92">Sales</div>
                  </div>
                  <div class="div-93">₱ 8,012.00</div>
                  <div class="div-94">
                    <div class="div-95">52%</div>
                    <img
                      loading="lazy"
                ...
                <div class="div-96">
                  <div class="div-97">
                    <img
                      ...
                      class="img-19"
                    />
                    <div class="div-98">15 in 1 Soap</div>
                  </div>
                  <div class="div-99">
                    <div class="div-100">50</div>
                    <div class="div-101">Sales</div>
                  </div>
                  <div class="div-102">₱ 7,342.00</div>
                  <div class="div-103">
                    <div class="div-104">49%</div>
                    <img
                      loading="lazy"
                      src="https://cdn.builder.io/api/v1/image/assets/TEMP/4c43a363-f109-46aa-add9-88fb816276a8?apiKey=3f6a7ddee9ae46558dc54af7e96aa0c9&"
                      class="img-20"
                    />
                  </div>
                </div>
                <div class="div-105">
                  ...
                  <div class="div-108">
                    <div class="div-109">47</div>
                    <div class="div-110">Sales</div>
                  </div>
                  <div class="div-111">₱ 7,012.00</div>
                  <div class="div-112">
                    <div class="div-113">30%</div>
                    <img
                      loading="lazy"
                      src="https://cdn.builder.io/api/v1/image/assets/TEMP/114d7ab2-7eaa-4d3d-a7d0-d9ff4730903b?apiKey=3f6a7ddee9ae46558dc54af7e96aa0c9&"
                      class="img-22"
                    />
                  </div>
                </div>
                <div class="div-114">
                  <div class="div-115">
                    <img
                      ...
                      class="img-23"
                    />
                    <div class="div-116">Glutamato with Grapeseed</div>
                  </div>
                  <div class="div-117">
                    <div class="div-118">38</div>
                    <div class="div-119">Sales</div>
                  </div>
                  <div class="div-120">₱ 5,612.00</div>
                  <div class="div-121">
                    <div class="div-122">30%</div>
                    <img
                      loading="lazy"
                      src="https://cdn.builder.io/api/v1/image/assets/TEMP/c2a84f1b-13cd-4d30-a89e-6c52e40ca9e0?apiKey=3f6a7ddee9ae46558dc54af7e96aa0c9&"
                      class="img-24"
                    />
                  </div>
                </div>
                <div class="div-123">
                  <div class="div-124">
                    <img
                      ...
                      class="img-25"
                    />
                    <div class="div-125">Gluta Oatmeal with Milk & Honey</div>
                  </div>
                  <div class="div-126">
                    <div class="div-127">30</div>
                    <div class="div-128">Sales</div>
                  </div>
                  <div class="div-129">₱ 5,112.00</div>
                  <div class="div-130">
                    <div class="div-131">27%</div>
                    <img
                      loading="lazy"
                      src="https://cdn.builder.io/api/v1/image/assets/TEMP/8dd27bde-e12c-4ccd-a586-ae129be0c7f0?apiKey=3f6a7ddee9ae46558dc54af7e96aa0c9&"
                      class="img-26"
                    />
                  </div>
                </div>
...
.div-6 {
  color: #3c652f;
  font: 500 27px/40.5px Poppins, sans-serif;
}
.div-7 {
  align-items: center;
  align-self: start;
...
.div-42 {
  border-radius: 20px;
  border: 1px solid rgba(239, 240, 246, 0.3);
  box-shadow: 5px 5px 20px 0px rgba(0, 0, 0, 0.05);
...
.div-55 {
  ...
  fill: #fff;
  stroke-width: 1px;
  stroke: var(--Stroke-Color, #eff0f6);
...
.div-60 {
  ...
  text-align: right;
  font: 600 10px/13px Inter, sans-serif;
}
.div-61 {
  color: var(--base-shade-100, #000);
  text-align: right;
...
.div-67 {
  ...
  font-feature-settings: "clig" off, "liga" off;
  align-self: stretch;
  font: 500 9px/11px Inter, sans-serif;
}
.div-68 {
  justify-content: center;
  color: #838383;
...
.div-81 {
  color: var(--light-version-neutral-blue-gray-600, #475569);
...
.div-87 {
  align-items: flex-start;
  border-top: 0.5px solid var(--light-version-neutral-blue-gray-400, #94a3b8);
...
.div-89 {
  color: var(--light-version-neutral-blue-gray-800, #1e293b);
...
.div-92 {
  color: var(--light-version-neutral-blue-gray-600, #475569);
  margin-top: 4px;
  font: 400 14px/20px Archivo, sans-serif;
}
.div-93 {
  align-self: center;
  color: var(--light-version-neutral-blue-gray-800, #1e293b);
...
.div-96 {
  align-items: flex-start;
  border-top: 0.5px solid rgba(148, 163, 184, 0.5);
  background-color: #fff;
  display: flex;
  width: 100%;
  justify-content: space-between;
...
.div-123 {
  align-items: flex-start;
  border-top: 0.5px solid var(--light-version-neutral-blue-gray-400, #94a3b8);
  border-bottom: 0.5px solid var(--light-version-neutral-blue-gray-400, #94a3b8);
  background-color: var(--white-white, #fff);
  display: flex;
  width: 100%;
  justify-content: space-between;
